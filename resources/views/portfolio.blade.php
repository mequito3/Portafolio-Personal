        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8 animate-on-scroll">
                    ...
                    <!-- Social Links -->
                    <div class="flex flex-col items-center lg:items-start gap-8 pt-4">
                        ...
                        {{-- Footer Logo --}}
                        <div class="relative flex items-center justify-center p-6 w-full max-w-[300px] mx-auto lg:mx-0">
                            <div class="absolute inset-0 bg-white/20 blur-[30px] rounded-full scale-125 mix-blend-lighten pointer-events-none"></div>
                            @if(isset($profile['logo']) && $profile['logo'])
                                <img src="{{ Str::startsWith($profile['logo'], 'http') ? $profile['logo'] : asset('storage/' . $profile['logo']) }}" 
                                     class="relative z-10 h-20 md:h-24 w-auto object-contain opacity-90 hover:opacity-100 transition-all duration-300 hover:scale-110">
                            @endif
                        </div>
                    </div>
                </div>
